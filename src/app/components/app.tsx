...
const TrackDetailsComponent = loadable(() =>
    import('./track-details/track-details.component')
);
const ArtistPage = loadable(() =>
    import('./artist-page/artist-page.component')
);
const UserTracksPage = loadable(() =>
    import('./user-tracks-page/user-tracks-page.component.')
);
const AlbumPageComponent = loadable(() =>
    import('./album-page/album-page.component')
);
...
export const App = ({ initialState = {} }: AppProps) => {
    if (
        ...
        !(initialState && initialState.accessToken)
    ) {
